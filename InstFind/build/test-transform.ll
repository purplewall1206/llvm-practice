...
@.str.2 = private unnamed_addr constant [12 x i8] c"%s  :  %lx\0A\00", align 1
...
entry:
  ...
  %x = call i64 asm "movq %rbp, $0", "=r"()
  call void @print_lx64(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @4, i32 0, i32 0), i64 %x)
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), i8* %0, i64 %1)
  ret void
}
...
entry:
  ...
  %call5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.5, i64 0, i64 0), i32 %4)
  ...
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.6, i64 0, i64 0), i64 %6)
...
!2 = !{i32 -2147340532, i32 -2147340515}
