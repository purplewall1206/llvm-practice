...
entry:
  ...
  %4 = load void (i8*, i64)*, void (i8*, i64)** %b, align 8
  call void %4(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i64 48879)
  ...
  %call6 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i64 0, i64 0), i64 %6)
